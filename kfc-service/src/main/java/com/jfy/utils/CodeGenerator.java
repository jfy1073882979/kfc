...
//    public static final String PACKAGE_NAME = "com.jfy";
//    public static void main(String[] args) throws Exception{
//        String[] tables = new String[] {"cart","discuss","role","t_order","t_order_detail","t_product","user"};//表名数组
//        String[] tablePrefixs = new String[] {"t_"}; //表示表的公共头部数组
//        executeCode(PACKAGE_NAME,tables,tablePrefixs); //调用executeCode方法
//    }
//    private static void executeCode(String pack,String[] tables,String[]
//            tablePrefixs) throws Exception{
//// 代码生成器
...
//        File dir = new File("kfc-parent/kfc-service");
...
//// 从试图获取
//        config.setUrl("jdbc:mysql://localhost:3306/kfc?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
...
//                }else {
//                    return projectPath + "/src/main/resources/mappers/" +
//                            pc.getModuleName() + "/" + tableInfo.getXmlName() + StringPool.DOT_XML;
//                }
//            }
//        });
